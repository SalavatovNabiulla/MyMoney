        ...
        fun get_transactions(server_url: String = ""): ArrayList<Transaction> {
            ...
            if(response.code == 200) {
                ...
                for (i in 0..json_data.length() - 1) {
                    ...
                    var json_transaction_wallet =
                        JSONObject(current_object.getJSONObject("wallet").toString())
                    ...
                    var json_transaction_wallet_type =
                        JSONObject(json_transaction_wallet.getJSONObject("type").toString())
                    ...
                    var json_transaction_revenue_item =
                        JSONObject(current_object.getJSONObject("revenue_item").toString())
                    if (json_transaction_revenue_item.length() != 0) {
                        ...
                        transaction.revenue_item.title =
                            json_transaction_revenue_item.getString("title")
                    }
                    var json_transaction_cost_item =
                        JSONObject(current_object.getJSONObject("cost_item").toString())
