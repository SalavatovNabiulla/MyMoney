...
import com.example.mymoney.activities.RevenueItemActivity
...
class RevenueItemAdapter(
    private val dataSet: List<Revenue_item>
    ) : RecyclerView.Adapter<RevenueItemAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View,server_ip : String = "") : RecyclerView.ViewHolder(view) {
        ...
        var last_tap : Long = 0
        init {
            id_text = view.findViewById(R.id.item_revenue_item_id_text)
            title_text = view.findViewById(R.id.item_revenue_item_title_text)
        }
    }
    ...
    fun double_click_listener(view: ViewHolder){
        ...
        GlobalScope.launch {
            var Intent = Intent(context,RevenueItemActivity::class.java)
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.item_revenue_item, viewGroup, false)
